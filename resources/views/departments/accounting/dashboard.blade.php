    ...
    <div class="pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in">
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                Accounting Department Admin Dashboard 📊
            </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-slide-up">
            ...
            <div class="stat-card rounded-2xl p-6">
                ...
                <a href="{{ route('accounting-admin.pending') }}" class="text-yellow-400 hover:text-yellow-300 text-xs mt-2 block">
                    View all →
                </a>
            </div>
            ...
            <div class="stat-card rounded-2xl p-6">
                ...
                <a href="{{ route('accounting-admin.active') }}" class="text-indigo-400 hover:text-indigo-300 text-xs mt-2 block">
                    View all →
                </a>
            </div>
            ...
            <div class="stat-card rounded-2xl p-6">
                ...
                <p class="text-gray-400 text-sm mt-2">Reviews</p>
                <a href="{{ route('accounting-admin.completed') }}" class="text-green-400 hover:text-green-300 text-xs mt-2 block">
                    View all →
                </a>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-slide-up">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="glass-card rounded-2xl p-6 border border-yellow-500/20">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('accounting-admin.pending') }}" class="text-sm text-yellow-400 hover:text-yellow-300">
                            View All →
                        </a>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="text-center py-8 border-2 border-dashed border-gray-700 rounded-xl">
                            ...
                            <p class="text-gray-500 mt-1">No pending assignments for accounting department</p>
                        </div>
                        @endforelse
                    </div>
                </div>
                ...
                <!-- Active Reviews -->
                <div class="glass-card rounded-2xl p-6 border border-indigo-500/20">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h2 class="text-xl font-semibold text-indigo-300">Active Accounting Reviews</h2>
                            <p class="text-sm text-gray-400 mt-1">Currently being reviewed by accounting staff</p>
                        </div>
                        <a href="{{ route('accounting-admin.active') }}" class="text-sm text-indigo-400 hover:text-indigo-300">
                            View All →
                        </a>
                    </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all group">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="px-2 py-1 text-xs rounded-full ml-2 {{ $review->status == 'assigned' ? 'bg-yellow-500/20 text-yellow-300' : 'bg-indigo-500/20 text-indigo-300' }}">
                            ...
                            <div class="ml-4 flex-shrink-0">
                                <a href="{{ route('contracts.show', $review->contract) }}" 
                                   class="px-3 py-1.5 text-xs bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-6">
                ...
                <div class="glass-card rounded-2xl p-6">
                    <h2 class="text-xl font-semibold mb-6">Accounting Admin Tools</h2>
                    <div class="space-y-4">
                ...
                <!-- Department Status -->
                <div class="glass-card rounded-2xl p-6">
                    <h2 class="text-xl font-semibold mb-4">Accounting Department Status</h2>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-blue-400">2.8 days</span>
                        </div>
                    </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
            <p>Accounting Department Admin • {{ now()->format('F j, Y') }}</p>
        </div>
    </div>
</x-app-layout-dark>