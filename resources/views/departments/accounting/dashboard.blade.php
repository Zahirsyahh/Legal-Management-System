<x-app-layout-dark title="Accounting Department Admin Dashboard">
    ...
    <div class="relative pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="fixed inset-0 overflow-hidden pointer-events-none">
            <div class="absolute -top-40 -right-40 w-80 h-80 bg-indigo-600/20 rounded-full blur-3xl animate-pulse"></div>
            <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-600/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div class="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="glass-stat rounded-2xl p-6">
                ...
                <a href="{{ route('accounting-admin.pending') }}" class="text-xs text-yellow-300/80 hover:text-yellow-300 mt-4 inline-flex items-center gap-1 transition-all">
                    View details 
            ...
            <div class="glass-stat rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-12 h-12 bg-indigo-500/10 rounded-xl flex items-center justify-center backdrop-blur-sm border border-indigo-500/20">
                        <svg class="w-6 h-6 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                </div>
                <a href="{{ route('accounting-admin.active') }}" class="text-xs text-indigo-300/80 hover:text-indigo-300 mt-4 inline-flex items-center gap-1 transition-all">
                    View details 
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div class="glass-stat rounded-2xl p-6">
                ...
                <a href="{{ route('accounting-admin.completed') }}" class="text-xs text-green-300/80 hover:text-green-300 mt-4 inline-flex items-center gap-1 transition-all">
                    View details 
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div class="glass-stat rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-300 text-sm mb-1 font-medium">Accounting Staff</p>
                        <p class="text-4xl font-bold text-white">
                            {{ \App\Models\TblUser::whereHas('roles', fn($q) => $q->where('nama_user', 'staff_acc'))->where('status_karyawan', true)->count() }}
                        </p>
        ...
        <div class="relative grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div class="glass-card rounded-2xl overflow-hidden">
                <div class="px-6 py-4 border-b border-white/10 flex justify-between items-center">
                    ...
                    <a href="{{ route('accounting-admin.pending') }}" class="text-sm text-yellow-300/80 hover:text-yellow-300 transition-all">
                        View All →
                    </a>
                </div>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr class="hover:bg-white/5 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('accounting-admin.assign', $assignment) }}" 
                ...
                <div class="px-6 py-3 border-t border-white/10 text-center">
                    <a href="{{ route('accounting-admin.pending') }}" class="text-xs text-yellow-300/70 hover:text-yellow-300 transition-all">
            ...
            <div class="glass-card rounded-2xl overflow-hidden">
                <div class="px-6 py-4 border-b border-white/10 flex justify-between items-center">
                    ...
                    <a href="{{ route('accounting-admin.active') }}" class="text-sm text-indigo-300/80 hover:text-indigo-300 transition-all">
                        View All →
                    </a>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr class="hover:bg-white/5 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium backdrop-blur-sm {{ $review->status == 'assigned' ? 'bg-yellow-500/20 text-yellow-300 border border-yellow-500/30' : 'bg-indigo-500/20 text-indigo-300 border border-indigo-500/30' }}">
                ...
                <div class="px-6 py-3 border-t border-white/10 text-center">
                    <a href="{{ route('accounting-admin.active') }}" class="text-xs text-indigo-300/70 hover:text-indigo-300 transition-all">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="w-full bg-white/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-r from-indigo-400 to-purple-400 h-2 rounded-full transition-all duration-700" style="width: {{ $rate }}%"></div>
                        </div>
                    </div>
