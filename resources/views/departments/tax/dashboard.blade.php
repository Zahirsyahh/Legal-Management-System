    ...
    <div class="pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in">
            <h1 class="text-3xl md:text-4xl font-bold mb-2">
                Tax Department Admin Dashboard 🧾
            </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-slide-up">
            ...
            <div class="stat-card rounded-2xl p-6">
                ...
                <a href="{{ route('tax-admin.pending') }}" class="text-yellow-400 hover:text-yellow-300 text-xs mt-2 block">
                    View all →
                </a>
            </div>
            ...
            <div class="stat-card rounded-2xl p-6">
                ...
                <a href="{{ route('tax-admin.active') }}" class="text-red-400 hover:text-red-300 text-xs mt-2 block">
                    View all →
                </a>
            </div>
            ...
            <div class="stat-card rounded-2xl p-6">
                ...
                <p class="text-gray-400 text-sm mt-2">Reviews</p>
                <a href="{{ route('tax-admin.completed') }}" class="text-green-400 hover:text-green-300 text-xs mt-2 block">
                    View all →
                </a>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-slide-up">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="glass-card rounded-2xl p-6 border border-yellow-500/20">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-400 mt-1">Tax reviews waiting for staff assignment</p>
                        </div>
                        <a href="{{ route('tax-admin.pending') }}" class="text-sm text-yellow-400 hover:text-yellow-300">
                            View All →
                        </a>
                    </div>
                    ...
                    <div class="space-y-3">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-2">
                                                <p class="text-sm font-semibold text-gray-300 group-hover:text-white truncate">
                                                    {{ $assignment->contract->contract_number ?? 'CTR-' . str_pad($assignment->contract->id, 4, '0', STR_PAD_LEFT) }}
                                                </p>
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 mt-2 text-xs text-gray-500">
                                            ...
                                            @endif
                                            @if($assignment->contract->tax_implications)
                        ...
                        <div class="text-center py-8 border-2 border-dashed border-gray-700 rounded-xl">
                            ...
                            <p class="text-gray-500 mt-1">No pending assignments for tax department</p>
                        </div>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="glass-card rounded-2xl p-6 border border-red-500/20">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h2 class="text-xl font-semibold text-red-300">Active Tax Reviews</h2>
                            <p class="text-sm text-gray-400 mt-1">Currently being reviewed by tax staff</p>
                        </div>
                        <a href="{{ route('tax-admin.active') }}" class="text-sm text-red-400 hover:text-red-300">
                            View All →
                        </a>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all group">
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center space-x-3">
                                    <div class="flex-shrink-0">
                                        <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-red-500/20 to-pink-500/20 flex items-center justify-center">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="px-2 py-1 text-xs rounded-full ml-2 {{ $review->status == 'assigned' ? 'bg-yellow-500/20 text-yellow-300' : 'bg-red-500/20 text-red-300' }}">
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 mt-2 text-xs text-gray-500">
                                            ...
                                            @if($review->contract->tax_compliance_deadline)
                                                @php
                                                    $deadline = \Carbon\Carbon::parse($review->contract->tax_compliance_deadline);
                                                    $daysLeft = $deadline->diffInDays(now());
                                                    $deadlineClass = $daysLeft <= 7 ? 'text-red-400' : 'text-gray-400';
                                                @endphp
                                                <span class="flex items-center {{ $deadlineClass }}">
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    </svg>
                                                    {{ $deadline->format('M d') }}
                            ...
                            <div class="ml-4 flex-shrink-0">
                                <a href="{{ route('contracts.show', $review->contract) }}" 
                                   class="px-3 py-1.5 text-xs bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-6">
                ...
                <div class="glass-card rounded-2xl p-6">
                    <h2 class="text-xl font-semibold mb-6">Tax Admin Tools</h2>
                    <div class="space-y-4">
                           ...
                           class="btn-primary flex items-center justify-between p-5 rounded-xl group">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-blue-200/70">Assign tax reviews to staff</p>
                                </div>
                            </div>
                           ...
                           class="btn-secondary flex items-center justify-between p-5 rounded-xl group">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Track tax review progress</p>
                                </div>
                            </div>
                            <svg class="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                           ...
                           class="btn-primary flex items-center justify-between p-5 rounded-xl group bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-green-200/70">View finished tax reviews</p>
                                </div>
                            </div>
                            <svg class="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                ...
                <div class="glass-card rounded-2xl p-6">
                    <h2 class="text-xl font-semibold mb-4">Tax Compliance Status</h2>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-400">Urgent Reviews</span>
                            <span class="text-sm font-medium text-red-400">
                                @php
                                    $urgentCount = 0;
                                    if(isset($activeReviews)) {
                                        $urgentCount = $activeReviews->filter(function($review) {
                                            if($review->contract->tax_compliance_deadline) {
                                                $deadline = \Carbon\Carbon::parse($review->contract->tax_compliance_deadline);
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-700">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-red-300">{{ $urgentCount }} urgent tax reviews</span>
                            </div>
                            @endif
                            @if($activeCount > 0)
                            <div class="flex items-center text-sm">
                ...
                <!-- Tax Deadlines -->
                <div class="bg-gradient-to-r from-red-500/10 to-orange-500/10 rounded-2xl border border-red-500/20 p-6">
                    <h3 class="text-lg font-semibold mb-3 text-red-300">Upcoming Deadlines</h3>
                    <div class="space-y-3">
                        @php
                            $upcomingDeadlines = [];
                            if(isset($activeReviews)) {
                                foreach($activeReviews as $review) {
                                    if($review->contract->tax_compliance_deadline) {
                                        $deadline = \Carbon\Carbon::parse($review->contract->tax_compliance_deadline);
                                        if($deadline->diffInDays(now()) <= 14) {
                                            $upcomingDeadlines[] = [
                                                'contract' => $review->contract,
                                                'deadline' => $deadline,
                                                'days_left' => $deadline->diffInDays(now())
                                            ];
                                        }
                                    }
                                }
                                ...
                                $upcomingDeadlines = array_slice($upcomingDeadlines, 0, 3);
                            }
                        @endphp
                        ...
                        @if(count($upcomingDeadlines) > 0)
                            @foreach($upcomingDeadlines as $item)
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-gray-300 truncate mr-2">
                                        {{ $item['contract']->contract_number ?? 'CTR-' . str_pad($item['contract']->id, 4, '0', STR_PAD_LEFT) }}
                                    </span>
                                    <span class="{{ $item['days_left'] <= 3 ? 'text-red-400 font-bold' : 'text-orange-400' }}">
        ...
        <div class="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
            <p>Tax Department Admin • {{ now()->format('F j, Y') }}</p>
        </div>
    </div>
</x-app-layout-dark>