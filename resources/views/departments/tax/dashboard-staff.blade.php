<x-app-layout-dark title="Tax Review Dashboard">
    @push('header')
    ...
    <div class="pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-slide-up">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="glass-card rounded-2xl p-6 border border-purple-500/20">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h2 class="text-xl font-semibold text-purple-300">My Assigned Reviews</h2>
                            <p class="text-sm text-gray-400 mt-1">Contracts assigned to you for tax review</p>
                        </div>
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('reviews.my-reviews') }}" 
                               class="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 rounded-lg text-sm font-medium transition-colors flex items-center">
                                ...
                                <div class="mt-6 space-y-3">
                                    ...
                                    <ul class="text-sm text-gray-500 space-y-1">
                                        <li class="flex items-center">
                                            ...
                                            Wait for tax admin to assign Document
                                        </li>
                                        <li class="flex items-center">
                                            <svg class="w-4 h-4 mr-2 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                            </svg>
                                            Browse all Document to see available ones
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="glass-card rounded-2xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                           ...
                           class="btn-primary flex items-center justify-between p-5 rounded-xl group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-purple-200/70">View all assigned contracts</p>
                                </div>
                            </div>
                        ...
                        <a href="{{ route('notifications.index') }}" 
                           class="btn-primary flex items-center justify-between p-5 rounded-xl group bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700">
                            <div class="flex items-center space-x-4">
                                <div class="p-3 rounded-lg bg-white/10">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-indigo-200/70">View all notifications</p>
                                </div>
                            </div>
                            <svg class="w-5 h-5 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
            ...
            <div class="space-y-6">
                ...
                <!-- Department Info -->
                <div class="glass-card rounded-2xl p-6">
                    <h2 class="text-xl font-semibold mb-4">Tax Department</h2>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-purple-400">{{ $activeReviewCount ?? 0 }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-400">Pending</span>
                        ...
                        @endif
                        @if(($recentAssignedCount ?? 0) > 0)
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-400">Recent</span>
                            <span class="text-sm font-medium text-blue-400">{{ $recentAssignedCount ?? 0 }} new</span>
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <!-- Help Card -->
                <div class="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl border border-purple-500/20 p-6">
                    <h3 class="text-lg font-semibold mb-2">Need Help?</h3>
                    <p class="text-sm text-gray-400 mb-4">Get assistance with tax reviews</p>
                    <div class="space-y-2">
                        <a href="#" class="block text-sm text-purple-400 hover:text-purple-300">Tax Review Guide</a>
                        <a href="#" class="block text-sm text-purple-400 hover:text-purple-300">Contact Tax Admin</a>
                        <a href="#" class="block text-sm text-purple-400 hover:text-purple-300">Tax Compliance Guidelines</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
            <p>Tax Department • {{ now()->format('F j, Y') }} • <span class="text-purple-400">All systems operational</span></p>
        </div>
    </div>
</x-app-layout-dark>