    ...
    <div class="relative pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="glass-stat rounded-2xl p-6">
                ...
                <a href="{{ route('finance-admin.completed') }}" class="text-xs text-green-300/80 hover:text-green-300 mt-4 inline-flex items-center gap-1 transition-all">
                    View details 
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
            ...
            <div class="glass-stat rounded-2xl p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-300 text-sm mb-1 font-medium">Finance Staff</p>
                        <p class="text-4xl font-bold text-white">
                            {{ \App\Models\TblUser::whereHas('roles', fn($q) => $q->where('nama_user', 'staff_finance'))->where('status_karyawan', true)->count() }}
                        </p>
                        <p class="text-gray-400 text-xs mt-2">Active members</p>
                    </div>
                    <div class="w-12 h-12 bg-cyan-500/10 rounded-xl flex items-center justify-center backdrop-blur-sm border border-cyan-500/20">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr class="hover:bg-white/5 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium backdrop-blur-sm {{ $review->status == 'assigned' ? 'bg-yellow-500/20 text-yellow-300 border border-yellow-500/30' : 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' }}">
                                        {{ ucfirst($review->status) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <a href="{{ route('contracts.show', $review->contract) }}" 
                                       class="glossy-btn px-3 py-1.5 text-xs bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 rounded-lg transition-all inline-flex items-center gap-1 border border-emerald-500/30">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="w-full bg-white/10 rounded-full h-2 overflow-hidden">
                            <div class="bg-gradient-to-r from-emerald-400 to-teal-400 h-2 rounded-full transition-all duration-700" style="width: {{ $rate }}%"></div>
                        </div>
                    </div>
