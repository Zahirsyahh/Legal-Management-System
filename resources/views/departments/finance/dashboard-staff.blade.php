    ...
    <div class="pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-slide-up">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            @if(($activeReviewCount ?? 0) > 0)
                                <span class="px-3 py-1 bg-green-500/20 text-green-300 text-xs rounded-full">
                                    {{ $activeReviewCount ?? 0 }} Active
                                </span>
                            @endif
                            <a href="{{ route('reviews.my-reviews') }}" 
                               class="px-3 py-1.5 bg-green-600 hover:bg-green-700 rounded-lg text-sm font-medium transition-colors flex items-center">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <span class="px-2 py-1 text-xs rounded-full ml-2 {{ 
                                                        ...
                                                        ($stage->status == 'in_progress' ? 'bg-green-500/20 text-green-300' : 
                                                        ($stage->status == 'completed' ? 'bg-blue-500/20 text-blue-300' : 
                        ...
                        @else
                            <div class="text-center py-12 border-2 border-dashed border-gray-700 rounded-xl">
                                ...
                                <p class="text-gray-500 mt-2 max-w-md mx-auto">
                                    You don't have any finance reviews assigned to you at the moment.
                                </p>
                                <div class="mt-6 space-y-3">
                                    ...
                                    <ul class="text-sm text-gray-500 space-y-1">
                                        <li class="flex items-center">
                                            ...
                                            Wait for finance admin to assign document
                                        </li>
                                        <li class="flex items-center">
                                            <svg class="w-4 h-4 mr-2 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                           ...
                           class="btn-primary flex items-center justify-between p-5 rounded-xl group bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-green-200/70">View all assigned contracts</p>
                                </div>
                            </div>
            ...
            <div class="space-y-6">
                ...
                <!-- Department Info -->
                <div class="glass-card rounded-2xl p-6">
                    <h2 class="text-xl font-semibold mb-4">Finance Department</h2>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                ...
                <div class="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-2xl border border-green-500/20 p-6">
                    ...
                    <div class="space-y-2">
                        <a href="#" class="block text-sm text-green-400 hover:text-green-300">Finance Review Guide</a>
                        <a href="#" class="block text-sm text-green-400 hover:text-green-300">Contact Finance Admin</a>
                        <a href="#" class="block text-sm text-green-400 hover:text-green-300">Budget Guidelines</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
            <p>Finance Department • {{ now()->format('F j, Y') }} • <span class="text-green-400">All systems operational</span></p>
        </div>
    </div>
</x-app-layout-dark>